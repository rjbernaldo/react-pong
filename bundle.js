...
/******/ 	var hotCurrentHash = "319c7d7742bcfbe4001d"; // eslint-disable-line no-unused-vars
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ReactPongApp = __webpack_require__(160);

	var _ReactPongApp2 = _interopRequireDefault(_ReactPongApp);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	(0, _reactDom.render)(_react2.default.createElement(_ReactPongApp2.default, null), document.getElementById('content'));
	...
	var ReactPongApp = function (_Component) {
		...
		_createClass(ReactPongApp, [{
			...
			value: function collisionHandler(x, y, done) {
				...
				var hitPaddle1X = x < this.paddle1.x + 20 && x > this.paddle1.x + 10;
			...
			value: function render() {
				return _react2.default.createElement(
					...
					_react2.default.createElement(
						'div',
						{ className: 'outer' },
						this.state.inGame ? _react2.default.createElement(_Scoreboard2.default, { className: 'center', player1Score: this.state.player1Score, player2Score: this.state.player2Score }) : _react2.default.createElement(_Menu2.default, { startGame: this.startGame.bind(this), className: 'center' })
					),
	    ...
	    _createClass(Ball, [{
	        ...
	        value: function move() {
	            ...
	            this.state.collisionHandler(this.x, this.y, function (hitUpperWall, hitLowerWall, hitPaddle1, hitPaddle2, hitLeftWall, hitRightWall) {
	                if (hitUpperWall) {
	                    _this2.yMovement = 0 + _this2.state.speed;
	                } else if (hitLowerWall) {
	                    _this2.yMovement = 0 - _this2.state.speed;
	                } else if (hitPaddle1) {
	                    _this2.xMovement = 0 + _this2.state.speed;
	                } else if (hitPaddle2) {
	                    _this2.xMovement = 0 - _this2.state.speed;
	                } else if (hitLeftWall) {
	                    // console.log('right wins');
	                    _this2.state.hitLeftWall();
	                    // this.xMovement = 0 + this.speed;
	                } else if (hitRightWall) {
	                        // console.log('left wins');
	                        _this2.state.hitRightWall();
	                        // this.xMovement = 0 - this.speed;
	                    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Paddle = function (_Component) {
	    _inherits(Paddle, _Component);

	    function Paddle(args) {
	        _classCallCheck(this, Paddle);

	        var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(Paddle).call(this));

	        _this.x = 0;
	        _this.y = args.clientHeight / 2;
	        _this.clientHeight = args.clientHeight;
	        args.control === 'human' ? _this.x = 50 : _this.x = args.clientWidth - 60;
	        args.movementHandler ? args.movementHandler(_this.move.bind(_this)) : null;
	        return _this;
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Scoreboard = function (_Component) {
	    ...
	    function Scoreboard(args) {
	        ...
	        return _possibleConstructorReturn(this, Object.getPrototypeOf(Scoreboard).call(this));
	    }
