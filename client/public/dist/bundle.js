...
/******/ 	var hotCurrentHash = "44f4dd1cfffd67086ae5"; // eslint-disable-line no-unused-vars
			...
			value: function render() {
				return _react2.default.createElement(
					...
					_react2.default.createElement(
						'canvas',
						{ ref: 'canvas', width: this.state.screenWidth, height: this.state.screenHeight },
						_react2.default.createElement(_Ball2.default, { initialX: this.state.screenWidth / 2, initialY: this.state.screenHeight / 2 })
					)
				);
			}
		}]);
